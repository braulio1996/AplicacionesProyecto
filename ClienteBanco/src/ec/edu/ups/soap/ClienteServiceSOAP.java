...
public interface ClienteServiceSOAP {
    ...
    @WebMethod
    @RequestWrapper(localName = "buscarCuenta", targetNamespace = "http://Services.ups.edu.ec/", className = "ec.edu.ups.soap.BuscarCuenta")
    @ResponseWrapper(localName = "buscarCuentaResponse", targetNamespace = "http://Services.ups.edu.ec/", className = "ec.edu.ups.soap.BuscarCuentaResponse")
    @WebResult(name = "return", targetNamespace = "")
    public ec.edu.ups.soap.Cuenta buscarCuenta(
        @WebParam(name = "arg0", targetNamespace = "")
        java.lang.String arg0
    );
}
