...
public interface ClienteServiceSOAP {
    ...
    @WebMethod
    @RequestWrapper(localName = "buscarCliente", targetNamespace = "http://Services.ups.edu.ec/", className = "ec.edu.ups.soap.BuscarCliente")
    @ResponseWrapper(localName = "buscarClienteResponse", targetNamespace = "http://Services.ups.edu.ec/", className = "ec.edu.ups.soap.BuscarClienteResponse")
    @WebResult(name = "return", targetNamespace = "")
    public ec.edu.ups.soap.ClienteSoap buscarCliente(
    ...
    public ec.edu.ups.soap.Respuesta transferencia2(
        ...
        java.lang.String arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        ec.edu.ups.soap.Transferencia arg1
    );
