 ...
 * 2020-07-08T14:54:18.526-05:00
 * Generated source version: 2.7.2
 * 
 */
@WebServiceClient(name = "ClienteServiceSOAPService", 
                  wsdlLocation = "http://localhost:18080/AplicacionesBanco/ClienteServiceSOAP?wsdl",
...
public class ClienteServiceSOAPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:18080/AplicacionesBanco/ClienteServiceSOAP?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ClienteServiceSOAPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:18080/AplicacionesBanco/ClienteServiceSOAP?wsdl");
        }
        WSDL_LOCATION = url;
    }
